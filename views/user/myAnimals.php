...
$myanimalquery = "select animalID,name,dateofbirth,description,photo from animal where animalID =(SELECT animalID FROM owns where userID = 'globaluserID') ";

$rows = $db->query($myanimalquery);
